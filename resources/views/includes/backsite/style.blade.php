...
<link rel="stylesheet" type="text/css" href="{{ asset('/assets/backsite/app-assets/vendors/css/selects/select2.min.css') }}">
<!-- END: Vendor CSS-->
...
<link rel="stylesheet" type="text/css" href="{{ asset('/assets/backsite/app-assets/css/core/colors/palette-tootltip.css') }}">
<!-- END: Page CSS-->
...
{{-- Third Party --}}
<link rel="stylesheet" href="{{ url('https://unpkg.com/boxicons@2.1.4/css/boxicons.min.css') }}">